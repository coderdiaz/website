        ...
        <Container className="max-w-3xl">
          <article>
            ...
            <div className="hidden md:flex justify-between">
              <div className="flex space-x-3 items-center text-gray-700 mb-6 md:mb-10">
            ...
            <p className="leading-loose italic mb-6 md:mb-10">
              <span className="pr-1 uppercase text-sm tracking-widest not-italic font-semibold bg-clip-text text-transparent bg-gradient-to-br from-rose-600 to-orange-600">Resumen »</span> {frontmatter.summary}
            </p>
