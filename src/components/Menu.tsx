    ...
    { isOpen ? <div className="py-10 md:hidden bg-white dark:bg-dark-500 top-0 left-0 fixed w-full h-full z-50">
      <div className="container mx-auto px-6 md:px-8 lg:px-4 xl:px-0 max-w-screen-lg relative">
        ...
        <div className="flex justify-left space-x-6 md:order-2 mb-4">
          ...
          <a href="https://github.com/coderdiaz" className="text-dark-100 hover:text-dark-500 dark:text-gray-400 dark-hover:text-gray-500">
          ...
          <a href="https://dribbble.com/coderdiaz" className="text-dark-100 hover:text-dark-500 dark:text-gray-400 dark-hover:text-gray-500">
