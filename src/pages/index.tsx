  ...
  return <Layout>
    <section className="md:pt-8 pb-2">
      <div className="container mx-auto px-6 md:px-8 lg:px-4 xl:px-0 max-w-screen-lg relative">
        ...
        <div className="mb-6 md:w-5/6 lg:w-7/12 relative">
          ...
          <p className="leading-relaxed text-lg mb-4 dark:text-gray-100">Currently, I'm developing platforms and websites with Jamstack. I mostly do <span className="text-">front-end</span> development but also back-end.</p>
          <p className="leading-relaxed text-lg mb-4 dark:text-gray-100">
    ...
    <section className="pt-2 pb-10">
      <div className="container mx-auto px-6 md:px-8 lg:px-4 xl:px-0 max-w-screen-lg">
        <h2 className="text-xl md:text-2.5xl font-bold font-inter mb-4 dark:text-white">What I do</h2>
        <div className="grid md:grid-cols-4 lg:grid-cols-3 gap-10">
          <div className="md:col-span-2 lg:col-span-1">
            <div className="bg-primary-500 w-20 h-20 md:w-auto md:h-auto py-6 px-4 rounded-2xl mb-4 flex justify-center align-middle">
            ...
            <p className="leading-relaxed mr-4 dark:text-gray-100">I build awesome software experiences using the best skills and technologies according to product.</p>
          </div>
          <div className="md:col-span-2 lg:col-span-1">
            <div className="bg-blue w-20 h-20 md:w-auto md:h-auto py-6 px-4 rounded-2xl mb-4 flex justify-center align-middle">
              <svg className="fill-current text-white text-opacity-75 w-28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                <path
            ...
            <p className="leading-relaxed mr-4 dark:text-gray-100">I develop user friendly and visually products. I build delightful experiences that let users achieve their goals.</p>
          </div>
          <div className="md:col-span-2 md:col-start-2 lg:col-span-1">
            <div className="bg-gray-700 w-20 h-20 md:w-auto md:h-auto py-6 px-4 rounded-2xl mb-4 flex justify-center align-middle">
              <svg className="fill-current text-white text-opacity-75 w-28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                <path
            ...
            <p className="leading-relaxed mr-4 dark:text-gray-100">Each person has a story and a goal. I will help you achieve your professional growth through software.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="pt-4 pb-20">
      <div className="container mx-auto px-6 md:px-8 lg:px-4 xl:px-0 max-w-screen-lg">
        <h2 className="text-2.5xl font-bold font-inter mb-2 dark:text-white">OSS Contributions</h2>
        <p className="leading-relaxed text-lg mb-12 md:w-112 dark:text-gray-100">
