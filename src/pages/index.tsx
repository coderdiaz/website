  ...
  return <Layout>
      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-4 xl:px-0 max-w-screen-lg">
        ...
        <div className="grid md:grid-cols-4 lg:grid-cols-3 gap-10">
          <div className="md:col-span-2 lg:col-span-1">
            <div className="bg-primary-500 border border-primary-700 w-20 h-20 md:w-auto md:h-auto py-6 px-4 rounded-2xl mb-4 flex justify-center align-middle">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <div className="bg-blue border border-blue-600 w-20 h-20 md:w-auto md:h-auto py-6 px-4 rounded-2xl mb-4 flex justify-center align-middle">
              <svg className="fill-current text-white text-opacity-75 w-28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                <path
          ...
          <div className="md:col-span-2 md:col-start-2 lg:col-span-1">
            <div className="bg-yellow-400 border border-yellow-600 w-20 h-20 md:w-auto md:h-auto py-6 px-4 rounded-2xl mb-4 flex justify-center align-middle">
              <svg className="fill-current text-white text-opacity-75 w-28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                <path
    ...
    <section className="pt-4 pb-4">
      <div className="container mx-auto px-6 md:px-8 lg:px-4 xl:px-0 max-w-screen-lg relative">
        ...
        <p className="leading-loose text-lg mb-16 md:w-112 dark:text-gray-100">This is a just part of them, have a look at my work! If you have an idea. <a className="border-b-2 border-gray-200 transition duration-200 ease-in-out hover:border-gray-400" href="mailto:hello@coderdiaz.me">Contact me</a>.</p>
