      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-4 xl:px-0 max-w-screen-lg">
        ...
        <div className="grid md:grid-cols-4 lg:grid-cols-3 gap-10">
          <div className="md:col-span-2 lg:col-span-1">
            <div className="bg-primary-500 w-20 h-20 py-6 px-4 rounded-2xl mb-4 flex justify-center align-middle">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <div className="bg-blue w-20 h-20 py-6 px-4 rounded-2xl mb-4 flex justify-center align-middle">
              <svg className="fill-current text-white text-opacity-75 w-28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                <path
          ...
          <div className="md:col-span-2  lg:col-span-1">
            <div className="bg-yellow-400 w-20 h-20 py-6 px-4 rounded-2xl mb-4 flex justify-center align-middle">
              <svg className="fill-current text-white text-opacity-75 w-28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                <path
