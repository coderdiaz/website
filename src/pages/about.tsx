  ...
  return <Layout>
    <section className="md:pt-8 pb-2">
      <div className="container mx-auto px-6 md:px-8 lg:px-4 xl:px-0 max-w-screen-md">
        <h1 className="text-3xl md:text-5xl font-bold font-inter mb-4">About me</h1>
        <p className="leading-relaxed text-lg mb-8 md:w-4/6">
          Hey, I'm Javier a.k.a. <span className="px-2 py-1 bg-gray-50 rounded-md">coderdiaz</span> a developer and creator building amazing platforms and websites with Jamstack. I live in Mexico City <span className="inline-block mx-1">🇲🇽</span> with my wife <a className="border-b-2 border-gray-200 transition duration-200 ease-in-out hover:border-gray-400" href="https://www.instagram.com/manzanita_becky/">Becky</a>.
        </p>
        ...
        <h2 className="text-xl md:text-2.5xl font-bold font-inter mb-4">Brief history</h2>
        <p className="leading-relaxed text-lg mb-4">
        ...
        <h2 className="text-xl md:text-2.5xl font-bold font-inter mb-4">Technology Stack</h2>
        <p className="leading-relaxed text-lg mb-4">
        ...
        <div className="grid grid-cols-6 md:grid-cols-12 gap-4 md:gap-8 mb-12">
          <div className="inline-flex items-center justify-center col-span-3 md:col-span-4 bg-notes rounded-lg px-6 py-4">
            Next.js
          </div>
          <div className="inline-flex items-center justify-center col-span-3 md:col-span-4 bg-notes rounded-lg px-6 py-4">
            React
          ...
          <div className="inline-flex items-center justify-center col-span-3 md:col-span-3 bg-notes rounded-lg px-6 py-4">
            GraphQL
          </div>
          <div className="inline-flex items-center justify-center col-span-3 md:col-span-3 bg-notes rounded-lg px-6 py-4">
            Vue
          ...
          <div className="inline-flex items-center justify-center col-span-6 md:col-span-6 bg-notes rounded-lg px-6 py-4">
        ...
        <h2 className="text-xl md:text-2.5xl font-bold font-inter mb-4">Teaching</h2>
        ...
        <h2 className="text-xl md:text-2.5xl font-bold font-inter mb-4">Web development</h2>
        <p className="leading-relaxed text-lg mb-4">
        ...
        <p className="leading-relaxed text-lg mb-16">
