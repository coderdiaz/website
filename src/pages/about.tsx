    ...
    <section className="md:pt-12 pb-8">
      <div className="container mx-auto px-6 md:px-8 lg:px-4 xl:px-0 max-w-screen-md">
        ...
        <p className="leading-loose text-lg mb-6 md:mb-12 md:w-4/6 dark:text-gray-100">
          Hey, I'm Javier a.k.a. <span className="px-2 py-1 bg-gray-50 dark:bg-dark-600 dark:text-gray-100 rounded-md">coderdiaz</span> a developer and creator building amazing platforms and websites with Jamstack. I live in Mexico City <span className="inline-block mx-1">🇲🇽</span> with my wife <a className="text-cyan-700 dark:text-cyan-300 font-medium shadow-link dark:shadow-darkLink" href="https://www.instagram.com/manzanita_becky/">Becky</a>.
        </p>
        ...
        <p className="leading-loose text-lg mb-4 dark:text-gray-100">
          In 2017, I travel to Mexico City to work in a Startup called <a className="text-cyan-700 dark:text-cyan-300 font-medium shadow-link dark:shadow-darkLink" href="https://pulpomatic.com">Pulpomatic</a>, a SaaS for fleet management, reduce costs and save time in management tasks. I was working in the migration from a older dashboard using a Monolitic archicture to better approach using services.
        </p>
        <p className="leading-loose text-lg mb-4 dark:text-gray-100">
          Same year, I left Pulpomatic to join a Mexico-based digital media publisher called <a className="text-cyan-700 dark:text-cyan-300 font-medium shadow-link dark:shadow-darkLink" href="https://pulpomatic.com">Cultura Colectiva</a>. It publishes content designed to be shared over social media networks targeted at a Latin American audience.
        </p>
        <p className="leading-loose text-lg mb-16 dark:text-gray-100">
          For 2019, I was looking for new challenges and I joined the <a className="text-cyan-700 dark:text-cyan-300 font-medium shadow-link dark:shadow-darkLink" href="https://bedu.org">BEDU</a> team, first as an Mentor in the Web Development Bootcamp and later as a Technical Leader in Software Engineering. Months later, I was invited to collaborate in the creation of a course in Platzi called <a className="text-cyan-700 dark:text-cyan-300 font-medium shadow-link dark:shadow-darkLink" href="https://platzi.com/cursos/vuejs-avanzado/">Advanced Vuejs</a> which I had the pleasure of recording at Platzi HQ in Bogota, Colombia.
        </p>
        ...
        <p className="leading-loose text-lg mb-8 dark:text-gray-100">
          My favorite libraries and frameworks are Vue, React, Nest.js, Next.js, Gatsby and Echo. Actually, I create my web designs using <a className="text-cyan-700 dark:text-cyan-300 font-medium shadow-link dark:shadow-darkLink" href="https://figma.com">Figma</a> and implementing on web using <a className="text-cyan-700 dark:text-cyan-300 font-medium shadow-link dark:shadow-darkLink" href="https://tailwindcss.com">TailwindCSS</a>, a utility-first CSS framework designed to rapid UI development.
        </p>
        ...
        <p className="leading-loose text-lg mb-16 dark:text-gray-100">
          If you would like me to speak to an upcoming event, please contact me at <a className="text-cyan-700 dark:text-cyan-300 font-medium shadow-link dark:shadow-darkLink" href="mailto:hello@coderdiaz.me">hello@coderdiaz.me</a>
        </p>
      </div>
    </section>
  </Layout>;
