  ...
  return <Layout>
    ...
    <section className="md:pt-6 pb-2">
      <div className="container mx-auto px-6 md:px-8 lg:px-4 xl:px-0 max-w-screen-md">
        ...
        <p className="leading-loose text-lg mb-4 dark:text-gray-100">
          In 2017, I travel to Mexico City to work in a Startup called <a className="border-b-2 border-gray-200 transition duration-200 ease-in-out hover:border-gray-400" href="https://pulpomatic.com">Pulpomatic</a>, a SaaS for fleet management, reduce costs and save time in management tasks. I was working in the migration from a older dashboard using a Monolitic archicture to better approach using services.
        </p>
        <p className="leading-loose text-lg mb-4 dark:text-gray-100">
          Same year, I left Pulpomatic to join a Mexico-based digital media publisher called <a className="border-b-2 border-gray-200 transition duration-200 ease-in-out hover:border-gray-400" href="https://pulpomatic.com">Cultura Colectiva</a>. It publishes content designed to be shared over social media networks targeted at a Latin American audience.
        </p>
        <p className="leading-loose text-lg mb-16 dark:text-gray-100">
