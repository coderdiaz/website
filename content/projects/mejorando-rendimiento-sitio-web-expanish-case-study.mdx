...
summary: Expanish es un sitio web multi-idioma que ofrece cursos para aprender el idioma español en diferentes sedes alrededor del mundo. Está construido usando Next.js y posee una capa de gestión de contenido (CMS) en Prismic desde el cual se actualiza la información del sitio.
...
meta:
  ...
  description: Implementar una cultura de rendimiento es algo muy importante. En esta ocasión, te compartiré que acciones y procesos realice para lograr mejoras significativas en el rendimiento de su sitio web.
...
<Image
  width={976}
  height={580}
  src="/static/images/mejorando-rendimiento-sitio-web-expanish-case-study/new-look-and-feel.png"
  alt="Página principal actual del sitio Expanish"
  caption="Página principal: Resultado final (Actualidad)" />