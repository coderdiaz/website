...
image: /static/images/about-page/coderdiaz-indahouse.png
meta:
...
<div className="tech-stack grid grid-cols-6 md:grid-cols-12 gap-4 md:gap-8 mb-16">
  <div className="inline-flex items-center font-semibold justify-center col-span-3 md:col-span-4 bg-gray-100 rounded-lg px-6 py-4">
  ...
  <div className="inline-flex items-center font-semibold justify-center col-span-3 md:col-span-3 bg-gray-100 rounded-lg px-6 py-4">
  ...
  <div className="inline-flex items-center font-semibold justify-center col-span-6 md:col-span-6 bg-gray-100 rounded-lg px-6 py-4">
...
Si quieres que de una charla en tu evento o reunión, por favor contáctame a [hey@coderdiaz.dev](mailto:hey@coderdiaz.dev) o a través de cualquier medio que te sea mejor desde [aquí](/contact).