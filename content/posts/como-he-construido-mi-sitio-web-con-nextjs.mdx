...
<Image
  width={976}
  height={580}
  src="/static/images/como-he-construido-mi-sitio-web-con-nextjs/coursely-platform-thumb.png"
  caption="Interfaz para una aplicación de cursos on-demand (@coderdiaz en Dribbble)" />
...
## ¿Qué sigue?
Quiero que este sea un espacio donde pueda crecer, y con suerte ayude a muchos en su carrera. Todavía hay mucho camino por delante por hacer y espero tener algunas iteraciones más adelante.

¿El sitio web está terminado? La verdad es que no. Todavía hay muchas cosas por hacer, pero por ahora estoy feliz con el resultado. Y eso es lo bonito de esto, siempre habrá algo que deba evolucionar para que logres eso que buscas que sea, recuerda, iterar es parte esencial en la construcción de un buen producto.
